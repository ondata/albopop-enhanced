...
$tags = explode(",",isset($_GET[PARAM_TAGS]) ? $_GET[PARAM_TAGS] : DEFAULT_TAGS);
...
switch($format) {
	case 'json':
		...
		echo toJson(fromEs($search,$without,$location,$tags,$size));
		break;
	case 'rss':
	default:
		require __DIR__ . '/torss.inc.php';
		header('Content-type: application/rss+xml');
		echo toRss(fromEs($search,$without,$location,$tags,$size));
		break;
}
?>
